...
final class CounterStrikeSourceTest extends TestCase
{
    public function testCanInstantiateAndQueryWithFixture(): void
    {
        ...
        $server = new CounterStrikeSource('127.0.0.1', 27015);

        $this->assertInstanceOf(CounterStrikeSource::class, $server);
