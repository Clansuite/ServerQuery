...
/**
 * Test parsing of AA fixture captured from live server.
 */
class AaFixtureTest extends TestCase
{
    private string $fixtureDir = __DIR__ . '/../../fixtures/gamespy2/v';

    public function testFixtureParsing(): void
    {
        $jsonFile = $this->fixtureDir . '/capture_24_91_54_97_1716.json';
