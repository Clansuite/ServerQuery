...
class MohwFixtureTest extends TestCase
{
    public function testQueryWithFixture(): void
    {
        // Note: No live Medal of Honor Warfighter servers available for testing
        ...
        $this->assertTrue(method_exists($mohw, 'query_server'));
