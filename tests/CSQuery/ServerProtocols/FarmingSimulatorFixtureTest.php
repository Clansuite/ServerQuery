...
final class FarmingSimulatorFixtureTest extends TestCase
{
    public function testFixtureExistsAndHasMetadata(): void
    {
        $dir = __DIR__ . '/../../../tests/fixtures/farmingsimulator/v1_0';

        $json = $dir . '/capture_farming_simulator_example_com_8080.json'; // Placeholder
