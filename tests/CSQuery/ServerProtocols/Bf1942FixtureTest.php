...
/**
 * Test parsing of Bf1942 fixture captured from live server.
 */
class Bf1942FixtureTest extends TestCase
{
    private string $fixtureDir = __DIR__ . '/../../fixtures/bf1942/vunknown';

    public function testFixtureExists(): void
    {
        $jsonFile = $this->fixtureDir . '/capture_37_187_92_162_14567.json';
