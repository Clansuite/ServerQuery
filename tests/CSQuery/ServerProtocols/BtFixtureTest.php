...
class BtFixtureTest extends TestCase
{
    public function testQueryWithFixture(): void
    {
        // Note: No live Medal of Honor Breakthrough servers available for testing
        ...
        $this->assertTrue(method_exists($bt, 'query_server'));
