...
/**
 * Test parsing of Mta fixture captured from live server.
 */
class MtaFixtureTest extends TestCase
{
    private string $fixtureDir = __DIR__ . '/../../fixtures/mta';

    public function testFixtureParsing(): void
    {
        $jsonFile = $this->fixtureDir . '/capture_51_91_91_111_22003.json';
