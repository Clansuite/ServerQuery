...
/**
 * Test parsing of Blackops fixture captured from live server.
 */
class BlackopsFixtureTest extends TestCase
{
    private string $fixtureDir = __DIR__ . '/../../fixtures/blackops';

    public function testFixtureParsing(): void
    {
        $jsonFile = $this->fixtureDir . '/capture_127_0_0_1_28960.json';
