...
/**
 * Test parsing of BFHL fixture captured from live server.
 */
class BfhlFixtureTest extends TestCase
{
    private string $fixtureDir = __DIR__ . '/../../fixtures/bf4/v';

    public function testFixtureParsing(): void
    {
        $jsonFile = $this->fixtureDir . '/capture_185_189_255_240_47600.json';
