...
/**
 * Test parsing of BFV fixture captured from live server.
 * Battlefield 1942 (BFV).
 */
class BfvFixtureTest extends TestCase
{
    private string $fixtureDir = __DIR__ . '/../../fixtures/bf1942/v';

    public function testFixtureParsing(): void
    {
        $jsonFile = $this->fixtureDir . '/capture_108_61_119_37_15567.json';
