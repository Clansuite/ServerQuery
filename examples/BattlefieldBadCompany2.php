...
$config = [
    'server_addr'     => '5.149.214.28',
    'server_port'     => 19567, // query port
    'request_timeout' => 2,
];

$server = new Bc2($config['server_addr'], $config['server_port']);

print "Querying Battlefield Bad Company 2 server {$config['server_addr']}:{$config['server_port']}...\n";
