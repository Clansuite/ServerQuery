...
$config = [
    'server_addr'     => '176.57.135.39',
    'server_port'     => 28300, // query port
    'request_timeout' => 2,
];

$server = new Conan($config['server_addr'], $config['server_port']);

print "Querying Conan Exiles server {$config['server_addr']}:{$config['server_port']}...\n";
