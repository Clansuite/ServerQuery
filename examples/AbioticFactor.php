...
// 85.170.255.213:7777
$config = [
    'server_addr'     => '85.170.255.213', // Replace with actual Abiotic Factor server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('abioticfactor', $config['server_addr'], $config['server_port']);

/** @var CSQuery $server */
print "Querying Abiotic Factor server {$config['server_addr']}:{$config['server_port']}...\n";
