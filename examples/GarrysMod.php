...
$config = [
    'server_addr'     => '37.230.228.47',
    'server_port'     => 27021, // query port
    'request_timeout' => 2,
];

$server = new Gmod($config['server_addr'], $config['server_port']);

print "Querying Garry's Mod server {$config['server_addr']}:{$config['server_port']}...\n";
