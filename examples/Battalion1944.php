...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Battalion 1944 server IP
    'server_port'     => 7780, // Default query port (game port 7777 + 3)
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('Battalion1944', $config['server_addr'], $config['server_port']);

print "Querying Battalion 1944 server {$config['server_addr']}:{$config['server_port']}...\n";
