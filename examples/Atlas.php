...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Atlas server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('atlas', $config['server_addr'], $config['server_port']);

print "Querying Atlas server {$config['server_addr']}:{$config['server_port']}...\n";
