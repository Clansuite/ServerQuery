...
$config = [
    'server_addr'     => '164.132.201.164',
    'server_port'     => 27015, // query port
    'request_timeout' => 2,
];

$server = new Hl2zp($config['server_addr'], $config['server_port']);

print "Querying Zombie Panic! Source server {$config['server_addr']}:{$config['server_port']}...\n";
