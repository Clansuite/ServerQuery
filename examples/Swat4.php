...
$config = [
    'server_addr'     => '191.101.30.155',
    'server_port'     => 10480, // game port, query is port + 1
    'request_timeout' => 2,
];

$server = new Swat4($config['server_addr'], $config['server_port']);

print "Querying SWAT 4 server {$config['server_addr']}:{$config['server_port']}...\n";
