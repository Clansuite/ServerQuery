...
$config = [
    'server_addr'     => '74.91.113.242',
    'server_port'     => 27960, // query port
    'request_timeout' => 2,
];

$server = new UrbanTerror($config['server_addr'], $config['server_port']);

print "Querying Urban Terror server {$config['server_addr']}:{$config['server_port']}...\n";
