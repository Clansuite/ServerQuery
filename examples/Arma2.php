...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual ARMA 2 server IP
    'server_port'     => 2303, // Default query port (game port 2302 + 1)
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('Arma2', $config['server_addr'], $config['server_port']);

print "Querying ARMA 2 server {$config['server_addr']}:{$config['server_port']}...\n";
