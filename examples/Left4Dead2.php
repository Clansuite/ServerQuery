...
$config = [
    'server_addr'     => '46.174.51.126',
    'server_port'     => 27015, // query port
    'request_timeout' => 2,
];

$server = new L4d2($config['server_addr'], $config['server_port']);

print "Querying Left 4 Dead 2 server {$config['server_addr']}:{$config['server_port']}...\n";
