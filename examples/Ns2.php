...
// Server from GameTracker: The Thirsty Onos
// IP: 185.83.152.202, Game Port: 28315, Query Port: 28316
$server = '185.83.152.202';
$port   = 28316;

print "Querying Natural Selection 2 server {$server}:{$port}\n";

$q = new Ns2($server, $port);
