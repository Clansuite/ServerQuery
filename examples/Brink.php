...
// Example server for Brink
// Find real servers at:
// https://www.gametracker.com/search/brink/
// https://steamcommunity.com/app/22350/discussions/0/864956089025375620/
$server = '127.0.0.1'; // Replace with real server IP
$port   = 27015; // Default Brink port, replace with real server port

print "Querying Brink server {$server}:{$port}\n";

$q = new Brink($server, $port);
