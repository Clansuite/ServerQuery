...
// Citadel: Forged with Fire server query - replace with actual server details
$serverAddress = '23.88.96.146';
$queryPort     = 28015;

print "Querying Citadel server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

$server = $csQuery->createInstance('citadel', $serverAddress, $queryPort);
