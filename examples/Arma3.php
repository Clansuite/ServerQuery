...
$config = [
    'server_addr'     => '54.38.154.47',
    'server_port'     => 2303, // query port
    'request_timeout' => 2,
];

$server = new Arma3($config['server_addr'], $config['server_port']);

print "Querying ARMA 3 server {$config['server_addr']}:{$config['server_port']}...\n";
