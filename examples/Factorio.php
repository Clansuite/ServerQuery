...
// Factorio server example - replace with actual server details
$serverAddress = 'factorio.example.com'; // Replace with actual server IP
$queryPort     = 34197; // Default Factorio port

print "Querying Factorio server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

$csQuery = new CSQuery;

try {
    $server = $csQuery->createInstance('factorio', $serverAddress, $queryPort);
