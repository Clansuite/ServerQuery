...
// BrainBread 2 server example - replace with actual server details
$serverAddress = '127.0.0.1'; // Replace with actual server IP
$queryPort     = 27015; // Replace with actual query port

print "Querying BrainBread 2 server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

try {
    $server = $csQuery->createInstance('brainbread2', $serverAddress, $queryPort);
