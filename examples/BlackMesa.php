...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Black Mesa server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('blackmesa', $config['server_addr'], $config['server_port']);

print "Querying Black Mesa server {$config['server_addr']}:{$config['server_port']}...\n";
