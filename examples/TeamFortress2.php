...
$config = [
    'server_addr'     => '85.117.240.14',
    'server_port'     => 27020, // query port
    'request_timeout' => 2,
];

$server = new Tf2($config['server_addr'], $config['server_port']);

print "Querying Team Fortress 2 server {$config['server_addr']}:{$config['server_port']}...\n";
