...
$config = [
    'server_addr'     => '142.132.192.19',
    'server_port'     => 7757, // query port
    'request_timeout' => 2,
];

$server = new Ror($config['server_addr'], $config['server_port']);

print "Querying Red Orchestra Ostfront 41-45 server {$config['server_addr']}:{$config['server_port']}...\n";
