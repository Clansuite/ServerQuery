...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Blade Symphony server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('bladesymphony', $config['server_addr'], $config['server_port']);

print "Querying Blade Symphony server {$config['server_addr']}:{$config['server_port']}...\n";
