...
// Call of Duty 2 server example
$serverAddress = '127.0.0.1'; // Replace with actual server IP
$queryPort     = 28960; // Default Call of Duty 2 query port

print "Querying Call of Duty 2 server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

try {
    $server = $csQuery->createInstance('cod2', $serverAddress, $queryPort);
