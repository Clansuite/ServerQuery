...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual America's Army 3 server IP
    'server_port'     => 27020, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('Aa3', $config['server_addr'], $config['server_port']);

print "Querying America's Army 3 server {$config['server_addr']}:{$config['server_port']}...\n";
