...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Fortress Forever server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('ff', $config['server_addr'], $config['server_port']);

print "Querying Fortress Forever server {$config['server_addr']}:{$config['server_port']}...\n";
