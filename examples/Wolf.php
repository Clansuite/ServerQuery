...
$config = [
    'server_addr'     => '216.245.177.45',
    'server_port'     => 27758, // query port
    'request_timeout' => 2,
];

$server = new Wolf($config['server_addr'], $config['server_port']);

print "Querying Wolfenstein PC server {$config['server_addr']}:{$config['server_port']}...\n";
