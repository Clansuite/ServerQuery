...
$config = [
    'server_addr'     => '162.248.88.25',
    'server_port'     => 27015, // query port
    'request_timeout' => 2,
];

$server = new Kf2($config['server_addr'], $config['server_port']);

print "Querying Killing Floor 2 server {$config['server_addr']}:{$config['server_port']}...\n";
