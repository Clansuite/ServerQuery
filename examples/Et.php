...
$config = [
    'server_addr'     => '135.148.137.185',
    'server_port'     => 27960, // query port
    'request_timeout' => 2,
];

$server = new Et($config['server_addr'], $config['server_port']);

print "Querying Wolfenstein Enemy Territory server {$config['server_addr']}:{$config['server_port']}...\n";
