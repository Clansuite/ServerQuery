...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Base Defense server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('basedefense', $config['server_addr'], $config['server_port']);

print "Querying Base Defense server {$config['server_addr']}:{$config['server_port']}...\n";
