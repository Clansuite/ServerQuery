...
// Cube 2: Sauerbraten server example
$serverAddress = '127.0.0.1'; // Replace with actual server IP
$queryPort     = 28763; // Default Sauerbraten game port (query uses port + 1)

print "Querying Cube 2: Sauerbraten server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

try {
    $server = $csQuery->createInstance('Sauerbraten', $serverAddress, $queryPort);
