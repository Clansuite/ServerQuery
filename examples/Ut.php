...
// Server from GameTracker: --- ComboGib CTF (Grapple) -- London --- EatSleepUT.com
// IP: 139.162.235.20, Game Port: 7777, Query Port: 7778
$server = '139.162.235.20';
$port   = 7778;

print "Querying Unreal Tournament server {$server}:{$port}\n";

$q = new Ut($server, $port);
