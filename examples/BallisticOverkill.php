...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Ballistic Overkill server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('ballisticoverkill', $config['server_addr'], $config['server_port']);

print "Querying Ballistic Overkill server {$config['server_addr']}:{$config['server_port']}...\n";
