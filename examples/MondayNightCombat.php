...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Monday Night Combat server IP
    'server_port'     => 27016, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('mnc', $config['server_addr'], $config['server_port']);

print "Querying Monday Night Combat server {$config['server_addr']}:{$config['server_port']}...\n";
