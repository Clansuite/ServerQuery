...
// Wurm Online server query - replace with actual server details
$serverAddress = '54.39.28.49';
$queryPort     = 27016;

print "Querying Wurm Online server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

$server = $csQuery->createInstance('wurm', $serverAddress, $queryPort);
