...
$config = [
    'server_addr'     => '104.238.176.249',
    'server_port'     => 27961, // query port
    'request_timeout' => 2,
];

$server = new QuakeLive($config['server_addr'], $config['server_port']);

print "Querying Quake Live server {$config['server_addr']}:{$config['server_port']}...\n";
