...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Insurgency Sandstorm server IP
    'server_port'     => 27016, // Default query port (game port + 1)
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('ins_sandstorm', $config['server_addr'], $config['server_port']);

print "Querying Insurgency Sandstorm server {$config['server_addr']}:{$config['server_port']}...\n";
