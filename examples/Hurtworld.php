...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Hurtworld server IP
    'server_port'     => 12881, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('hurtworld', $config['server_addr'], $config['server_port']);

print "Querying Hurtworld server {$config['server_addr']}:{$config['server_port']}...\n";
