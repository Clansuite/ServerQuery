...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual America's Army: Proving Grounds server IP
    'server_port'     => 27020, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('Aapg', $config['server_addr'], $config['server_port']);

print "Querying America's Army: Proving Grounds server {$config['server_addr']}:{$config['server_port']}...\n";
