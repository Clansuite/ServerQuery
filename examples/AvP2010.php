...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Aliens vs. Predator 2010 server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('avp2010', $config['server_addr'], $config['server_port']);

print "Querying Aliens vs. Predator 2010 server {$config['server_addr']}:{$config['server_port']}...\n";
