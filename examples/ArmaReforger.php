...
$config = [
    'server_addr'     => '64.44.205.195',
    'server_port'     => 2001, // query port = game port + 1
    'request_timeout' => 2,
];

$server = new ArmaReforger($config['server_addr'], $config['server_port']);

print "Querying ARMA: Reforger server {$config['server_addr']}:{$config['server_port']}...\n";
