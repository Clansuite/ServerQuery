...
// Call of Duty server example
$serverAddress = '127.0.0.1'; // Replace with actual server IP
$queryPort     = 28960; // Default Call of Duty query port

print "Querying Call of Duty server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

try {
    $server = $csQuery->createInstance('cod', $serverAddress, $queryPort);
