...
$config = [
    'server_addr'     => '127.0.0.1', // Replace with actual Age of Chivalry server IP
    'server_port'     => 27015, // Default query port
    'request_timeout' => 2,
];

$factory = new CSQuery;
$server  = $factory->createInstance('aoc', $config['server_addr'], $config['server_port']);

print "Querying Age of Chivalry server {$config['server_addr']}:{$config['server_port']}...\n";
