...
// Tibia server query - replace with actual server details
$serverAddress = '127.0.0.1';
$queryPort     = 7171;

print "Querying Tibia server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

$server = $csQuery->createInstance('tibia', $serverAddress, $queryPort);
