...
// Colony Survival server example - replace with actual server details
$serverAddress = '127.0.0.1'; // Replace with actual server IP
$queryPort     = 27015; // Replace with actual query port

print "Querying Colony Survival server at {$serverAddress}:{$queryPort}..." . \PHP_EOL;

try {
    $server = $csQuery->createInstance('colonysurvival', $serverAddress, $queryPort);
