...
$config = [
    'server_addr'     => '94.23.252.71',
    'server_port'     => 29170, // query port
    'request_timeout' => 2,
];

$server = new StarWarsJK($config['server_addr'], $config['server_port']);

print "Querying Star Wars Jedi Knight server {$config['server_addr']}:{$config['server_port']}...\n";
