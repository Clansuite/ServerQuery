...
$config = [
    'server_addr'     => '74.91.120.44',
    'server_port'     => 27034, // query port
    'request_timeout' => 2,
];

$server = new Ins($config['server_addr'], $config['server_port']);

print "Querying Insurgency server {$config['server_addr']}:{$config['server_port']}...\n";
