...
// Example server for Minecraft Pocket Edition (note: servers are rare)
// Server IP: example.com, Port: 19132

$server = 'example.com';
$port   = 19132;

print "Querying Minecraft Pocket Edition server {$server}:{$port}\n";

$q = new Minecraftpe($server, $port);
