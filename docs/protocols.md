...
This document lists the server protocols supported, organized in a hierarchical tree structure. Each protocol serves as a top-level category, with the games they support listed underneath.
