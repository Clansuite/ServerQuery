...
/**
 * Red Orchestra Ostfront 41-45 protocol implementation.
 *
 * Uses Unreal2 query protocol.
 */
class Ror extends Unreal2 implements ProtocolInterface
{
    /**
     * Protocol name.
     */
     ...
     * @var array<string>
     */
    public array $supportedGames = ['Red Orchestra Ostfront 41-45'];

    /**
     * Protocol identifier.
     */
    public string $protocol = 'ror';
