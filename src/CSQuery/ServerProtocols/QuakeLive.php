...
/**
 * Quake Live protocol implementation.
 *
 * Uses Quake 3 query protocol.
 */
class QuakeLive extends Quake3Arena implements ProtocolInterface
{
    /**
     * Protocol name.
     */
    public string $name = 'QuakeLive';
     ...
     * @var array<string>
     */
    public array $supportedGames = ['Quake Live'];

    /**
     * Protocol identifier.
     */
    public string $protocol = 'ql';
