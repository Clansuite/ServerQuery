...
/**
 * ArmA Armed Assault protocol implementation.
 *
 * Uses Gamespy2 query protocol.
 */
class Arma extends Gamespy2 implements ProtocolInterface
{
    /**
     * Protocol name.
     */
    public string $name = 'Arma';
     ...
     * @var array<string>
     */
    public array $supportedGames = ['ArmA Armed Assault'];

    /**
     * Protocol identifier.
     */
    public string $protocol = 'arma';
