...
/**
 * Urban Terror protocol implementation.
 *
 * Uses Quake 3 query protocol.
 */
class UrbanTerror extends Quake3Arena implements ProtocolInterface
{
    /**
     * Protocol name.
     */
    public string $name = 'UrbanTerror';
     ...
     * @var array<string>
     */
    public array $supportedGames = ['Urban Terror'];

    /**
     * Protocol identifier.
     */
    public string $protocol = 'urbanterror';
