...
/**
 * Unreal Tournament 3 protocol implementation.
 *
 * Uses Gamespy3 query protocol.
 */
class Ut3 extends Gamespy3 implements ProtocolInterface
{
    /**
     * Protocol name.
     */
    public string $name = 'Ut3';
     ...
     * @var array<string>
     */
    public array $supportedGames = ['Unreal Tournament 3'];

    /**
     * Protocol identifier.
     */
    public string $protocol = 'ut3';
