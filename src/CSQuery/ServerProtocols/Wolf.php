...
/**
 * Wolfenstein PC protocol implementation.
 *
 * Uses Quake 3 query protocol.
 */
class Wolf extends Quake3Arena implements ProtocolInterface
{
    /**
     * Protocol name.
     */
     ...
     * @var array<string>
     */
    public array $supportedGames = ['Wolfenstein PC'];

    /**
     * Protocol identifier.
     */
    public string $protocol = 'wolf';
