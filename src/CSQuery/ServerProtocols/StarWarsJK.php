...
/**
 * Star Wars Jedi Knight protocol implementation.
 *
 * Uses Quake 3 query protocol.
 */
class StarWarsJK extends Quake3Arena implements ProtocolInterface
{
    /**
     * Protocol name.
     */
    public string $name = 'StarWarsJK';
     ...
     * @var array<string>
     */
    public array $supportedGames = ['Star Wars Jedi Knight'];

    /**
     * Protocol identifier.
     */
    public string $protocol = 'StarWarsJK';
